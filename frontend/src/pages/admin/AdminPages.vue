...
const pages = [
  ...
  { slug: 'guild-membership', label: () => 'Guild — membership banner' },
  { slug: 'guild-intro', label: () => 'Guild — intro' },
  { slug: 'guild-philosophy', label: () => 'Guild — philosophy' },
  { slug: 'guild-code', label: () => 'Guild — code of conduct' },
