    ...
    public function run(): void
    {
        $members = [
            [
                ...
                'is_instructor' => true,
                'bio' => [
                    'lv' => 'Kluba dibinātājs un galvenais instruktors. Vada treniņus pēc Joahima Meijera traktāta, specializējies garajā zobenā un cīniņā bez ieročiem. Piedalījies vairākos vēsturiskās paukošanas turnīros Baltijā un Skandināvijā.',
                    'en' => 'Founder and head instructor. Leads training based on the treatise of Joachim Meyer, specialising in longsword and unarmed grappling. Has competed at historical fencing tournaments across the Baltic and Scandinavia.',
                    'ru' => 'Основатель клуба и главный инструктор. Ведёт тренировки по трактату Иоахима Мейера, специализируется на длинном мече и борьбе. Участвовал в турнирах по историческому фехтованию в странах Балтии и Скандинавии.',
                    'cs' => 'Zakladatel klubu a hlavní instruktor. Vede výuku podle traktátu Joachima Meyera se zaměřením na dlouhý meč a zápas. Účastnil se turnajů historického šermu po celém Pobaltí a Skandinávii.',
                    'de' => 'Gründer und leitender Ausbilder. Unterrichtet nach dem Traktat Joachim Meyers mit Schwerpunkt auf Langschwert und Ringen. Teilnahme an Turnieren für historisches Fechten im Baltikum und in Skandinavien.',
                    'lineage' => [
                    ...
                    'seminars' => [
                        'en' => 'Nordic Historical Fencing Open (2023, 2024), Swordfish (2023), Baltic Sword (2022–2025)',
                        'lv' => 'Nordic Historical Fencing Open (2023, 2024), Swordfish (2023), Baltic Sword (2022–2025)',
                    ],
                ],
            ],
            [
